...
$styles = [
    ...
    'neonpop' => [
      ...
      '--bg-light'           => '#08090f',
      '--card-bg'            => '#1a2235',   // claramente distinto do fundo
      '--accent-color'       => '#00BFFF',
      '--on-accent'          => '#000d1a',
      '--link-color'         => '#67e8f9',
      '--text-color'         => '#E5E7EB',
      ...
      '--header-title-color' => '#00BFFF',
      '--header-muted'       => 'rgba(0,191,255,0.70)',
      '--header-border'      => 'rgba(0,191,255,0.22)',
      '--focus-ring'         => '3px solid #00BFFF',
     ...
     */
    'vintagecafe' => [
      '--primary-color'      => '#2e1a0e',
      '--bg-light'           => '#1e1008',
      '--card-bg'            => '#3d2510',   // marrom mais claro — distinto do header e fundo
      '--accent-color'       => '#D4AF37',
      '--on-accent'          => '#1a0f00',
      '--link-color'         => '#f0c84a',
      '--text-color'         => '#FFF3DC',
      '--muted-text'         => 'rgba(255,243,220,0.80)',
      '--border-color'       => 'rgba(212,175,55,0.25)',
      '--header-title-color' => '#F5DEB3',
      '--header-muted'       => 'rgba(245,222,179,0.70)',
    ...
    'campoepaixao' => [
      ...
      '--bg-light'           => '#071a0d',   // fundo de página escuro
      '--card-bg'            => '#133d20',   // verde levemente mais claro que o header
      '--accent-color'       => '#e60000',
      '--on-accent'          => '#ffffff',
      '--link-color'         => '#fbbf24',
      '--text-color'         => '#F0FAF2',
      '--muted-text'         => 'rgba(240,250,242,0.72)',
      '--border-color'       => 'rgba(255,255,255,0.14)',
      '--header-title-color' => '#ffffff',
      '--header-muted'       => 'rgba(255,255,255,0.72)',
      '--header-border'      => 'rgba(255,255,255,0.14)',
      '--focus-ring'         => '3px solid #e60000',
      '--font-main'          => "'Inter', system-ui, sans-serif",
      '--font-title'         => "'Montserrat', 'Inter', system-ui, sans-serif",
      '--radius-sm'          => '6px',
      '--radius-md'          => '10px',
    ...
    'ceuafe' => [
      ...
      '--bg-light'           => '#111e2e',
      '--card-bg'            => '#1e3460',   // azul mais distinto do bg-light
      '--accent-color'       => '#C9A84C',
      '--on-accent'          => '#0e1a28',
      '--link-color'         => '#7EC8F0',
      '--text-color'         => '#EFF4FB',
      '--muted-text'         => 'rgba(215,230,248,0.85)',
      '--border-color'       => 'rgba(201,168,76,0.20)',
      '--header-title-color' => '#E8C96A',
      '--header-muted'       => 'rgba(232,201,106,0.72)',
